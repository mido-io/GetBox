/**
 * Lightweight inline SVG icons to replace react-icons/lu.
 * This eliminates the massive react-icons bundle from the client JS.
 * All icons follow the Lucide design system: 24x24, stroke-width 2, round caps/joins.
 */
...
function Icon({ children, className, ...props }) {
  return (
    <svg {...ICON_DEFAULTS} className={className} {...props}>
      {children}
    </svg>
  );
}
